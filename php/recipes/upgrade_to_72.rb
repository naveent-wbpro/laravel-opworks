...
when "debian", "ubuntu"
  ...
  execute "apt_install" do
    user "root"
    command "apt-get -y --force-yes install php7.2 php7.2-cli php7.2-common php7.2-mbstring php7.2-mcrypt php7.2-mysql php7.2-xml php7.2-curl php7.2-json php7.2-opcache php7.2-zip php7.2-fpm"
